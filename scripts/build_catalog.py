...
EXPLICIT_REMAP = {
    ...
    'drops/luffy-1-beige-front': ('drops', 'luffy-1', 'Beige', 'front'),
    'drops/luffy-1-black-back': ('drops', 'luffy-1', 'Black', 'back'),
    ...
    'drops/naruto-3-beige-back': ('drops', 'naruto-6', 'Beige', 'back'),
    'drops/naruto-3-beige-front': ('drops', 'naruto-6', 'Beige', 'front'),
    ...
    'acid/sakuna-black-front': ('acid', 'sakuna', 'Black', 'front'),
    ...
    'acid/zoro-1-black-back': ('acid', 'zoro-2', 'Black', 'back'),
    'acid/zoro-1-black-front': ('acid', 'zoro-2', 'Black', 'front'),
    'acid/zoro-2-grey-front': ('acid', 'zoro-2', 'Grey', 'front'),
    'regular/baby-whiet-back': ('regular', 'baby', 'White', 'back'),
    'regular/baby-whiet-front': ('regular', 'baby', 'White', 'front'),
    'regular/berserkbeige-back': ('regular', 'berserk-3', 'Beige', 'back'),
    'regular/berserkbeige-front': ('regular', 'berserk-3', 'Beige', 'front'),
    'regular/berserkwhte-back': ('regular', 'berserk-3', 'White', 'back'),
    'regular/berserkwhte-front': ('regular', 'berserk-3', 'White', 'front'),
    ...
    'regular/eye-beige-back': ('regular', 'eye-2', 'Beige', 'back'),
    'regular/eye-beige-front': ('regular', 'eye-2', 'Beige', 'front'),
    'regular/eyewhite-back': ('regular', 'eye-2', 'White', 'back'),
    'regular/eyewhite-front': ('regular', 'eye-2', 'White', 'front'),
    ...
    'regular/sukunagrey-front': ('regular', 'sukuna', 'Grey', 'front'),
    'regular/sakuna-white-back': ('regular', 'sukuna', 'White', 'back'),
    'regular/sakuna-white-front': ('regular', 'sukuna', 'White', 'front'),
    'regular/sakuna-blue-back': ('regular', 'sukuna', 'Blue', 'back'),
    'regular/sakuna-blue-front': ('regular', 'sukuna', 'Blue', 'front'),
    'regular/sukuna-beige-back': ('regular', 'sukuna-2', 'Beige', 'back'),
    'regular/sukuna-beige-front': ('regular', 'sukuna-2', 'Beige', 'front'),
    'regular/sukuna-white-back': ('regular', 'sukuna-2', 'White', 'back'),
    'regular/sukuna-white-front': ('regular', 'sukuna-2', 'White', 'front'),
