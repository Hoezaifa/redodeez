  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#0a0a0a] border-y border-zinc-800/60">
      ...
      <div className="relative z-10 edge">
        ...
        <div className="flex flex-col md:grid md:grid-cols-12 gap-0 items-stretch py-10 lg:py-14 min-h-[380px]">
          {/* ── Left Column / Mobile Flow Content ── */}
          <div className="contents md:flex md:flex-col md:justify-center md:col-span-7 lg:col-span-5 md:pr-8 lg:pr-12 md:pl-4 lg:pl-8">
            {/* Header & Subtitle */}
            <div className="order-1 md:order-none flex flex-col items-center text-center md:items-start md:text-left">
              <Reveal>
                {/* Logo + badge */}
                <div className="flex items-center gap-3 mb-5 md:mb-6">
                  <img src={LOGO_URL} alt="Deez Prints" className="h-5 md:h-6 w-auto" />
                  <span className="flex items-center gap-1.5 text-[9px] font-mono font-bold text-zinc-400 md:text-zinc-500 uppercase tracking-[0.2em]">
                    <Globe className="w-3 h-3 text-zinc-500 md:text-zinc-600" />
                    Printed in Pakistan
                  </span>
                </div>

                {/* Heading - Exactly ONE h2 */}
                <h2 className="font-display text-[40px] sm:text-5xl lg:text-6xl xl:text-7xl font-black uppercase tracking-tight text-white leading-[0.92]">
                  YOUR DESIGN.
                  <br />
                  <span className="text-primary">NO LIMITS.</span>
                </h2>

                <p className="text-xs sm:text-sm text-zinc-400 font-sans leading-relaxed mt-3 md:mt-4 max-w-[260px] sm:max-w-sm mx-auto md:mx-0">
            ...
            {/* Steps */}
            <div className="order-3 md:order-none w-full my-5 md:my-0 md:mt-7 md:pt-5 md:border-t md:border-zinc-800/50">
              <Reveal delay={0.1}>
                <div className="grid grid-cols-3 gap-2 md:flex md:items-start md:gap-6 w-full">
                  <div className="flex flex-col items-center md:flex-row gap-1.5 md:gap-2 py-3 px-2 md:py-0 md:px-0 bg-zinc-900/60 md:bg-transparent border border-zinc-800/50 md:border-0">
                    <div className="w-8 h-8 flex items-center justify-center border border-zinc-700 text-primary shrink-0">
            ...
            {/* CTAs */}
            <div className="order-4 md:order-none w-full">
              <Reveal delay={0.15}>
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:mt-7">
                  <Link
                    to="/custom-print"
                    className="w-full sm:w-auto py-3.5 px-6 lg:px-7 bg-primary text-black font-mono font-black uppercase text-xs md:text-[11px] tracking-widest flex items-center justify-center gap-2.5 hover:bg-primary/90 transition-colors active:scale-[0.98] shadow-lg shadow-primary/20"
                  >
          ...
          {/* ── Center Column: T-Shirt mockup (single instance) ── */}
          <div className="order-2 md:order-none col-span-12 md:col-span-5 lg:col-span-5 relative flex items-center justify-center my-6 md:my-0">
            <Reveal delay={0.15}>
              <div className="relative w-full max-w-[300px] sm:max-w-[360px] md:max-w-[420px] mx-auto">
                ...
                {/* Mockup image */}
                <div className="relative z-10 w-full aspect-[4/5] overflow-hidden bg-zinc-950 border border-zinc-800/60 md:border-0 md:bg-transparent">
                  <img
                    src={MOCKUP_IMG}
                  ...
                  <div className="absolute top-[12%] left-[15%] w-4 h-4 md:w-5 md:h-5 border-l-[2.5px] border-t-[2.5px] border-primary" />
                  <div className="absolute top-[12%] right-[15%] w-4 h-4 md:w-5 md:h-5 border-r-[2.5px] border-t-[2.5px] border-primary" />
                  <div className="absolute bottom-[22%] left-[15%] w-4 h-4 md:w-5 md:h-5 border-l-[2.5px] border-b-[2.5px] border-primary" />
                  <div className="absolute bottom-[22%] right-[15%] w-4 h-4 md:w-5 md:h-5 border-r-[2.5px] border-b-[2.5px] border-primary" />

                  {/* "PRINT AREA" tag */}
                  <div className="absolute top-[9%] left-1/2 -translate-x-1/2 bg-primary px-2.5 md:px-3 py-0.5 md:py-1 text-[8px] md:text-[9px] font-mono font-black text-black uppercase tracking-[0.2em]">
                    Print Area
                  </div>

                  {/* "YOUR DESIGN HERE" text */}
                  <div className="absolute top-[28%] left-1/2 -translate-x-1/2 text-center pointer-events-none">
                    <p className="font-display text-2xl sm:text-3xl lg:text-4xl font-black text-white uppercase tracking-tight leading-[0.95] drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
                      YOUR
                      <br />
                      DESIGN
                      <br />
                  ...
                  {/* Deez Prints circular badge (visible on desktop) */}
                  <div className="hidden md:flex absolute bottom-[8%] left-[8%] w-14 h-14 rounded-full border-2 border-primary/60 items-center justify-center opacity-60">
          ...
          {/* ── Right Column: "MAKE IT YOURS" sidebar (desktop only) ── */}
          <div className="col-span-2 hidden lg:flex flex-col justify-center pl-4 border-l border-zinc-800/40">
            <Reveal delay={0.25}>
