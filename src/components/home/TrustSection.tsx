      ...
      <div className="edge relative z-10 space-y-20 lg:space-y-28">
        ...
        <div className="space-y-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 border-b border-white/10 pb-6">
            <div>
              <p className="label-mono text-primary">Real Feedback</p>
              <h3 className="text-2xl font-bold uppercase tracking-tight text-white mt-1">
                What Our Customers Say
              </h3>
            </div>
            <div className="flex items-center gap-2 bg-zinc-900 border border-white/10 px-4 py-2 rounded-xl text-xs">
              ...
              <span className="text-zinc-500">· 500+ Reviews</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, idx) => (
              <Reveal key={t.name} delay={idx * 0.08}>
                <div className="h-full bg-zinc-950 border border-white/10 rounded-2xl p-6 flex flex-col justify-between hover:border-white/20 transition-all">
